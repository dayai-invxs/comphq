      ...
      <nav className="bg-gray-900 border-b border-gray-800 px-6 py-3">
        <div className="flex items-center justify-between">
          ...
          <div className="hidden lg:flex items-center gap-4 ml-auto">
            ...
            <Link href={`/${slug}/ops`} target="_blank" className="text-xs text-gray-500 hover:text-gray-300">Athlete Overview</Link>
        ...
        {menuOpen && (
          <div className="lg:hidden mt-3 pb-2 flex flex-col gap-1 border-t border-gray-800 pt-3">
            ...
            <div className="border-t border-gray-800 mt-2 pt-2 flex flex-col gap-1">
              ...
              <Link href={`/${slug}/ops`} target="_blank" className="px-2 py-2 text-sm text-gray-500 hover:text-gray-300">Athlete Overview</Link>
