    ...
    <div className="space-y-12 max-w-xl">
      ...
      <section className="space-y-4">
        ...
        <div className="bg-gray-900 rounded-xl p-6 space-y-4">
          ...
          <div>
            <label className="block text-sm text-white font-medium mb-1">Judge Max Consecutive Heats</label>
            <p className="text-xs text-gray-500 mb-2">Highlight violations and cap auto-assignment when a judge exceeds this many heats in a row.</p>
            <input
              type="number"
              min={1}
              max={20}
